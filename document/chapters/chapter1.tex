...
\begin{itemize}
    \item \textbf{Apenas referência}:~\cite{3gpp.22.101}
    \item \textbf{Apenas data}:~\citedate{3gpp.22.101}
    \item \textbf{Apenas ano}:~\citeyear{3gpp.22.101}
    \item \textbf{Apenas autor}:~\citeauthor{3gpp.22.101}
    \item \textbf{Apenas editor}:\citelist{3gpp.22.101}{institution}
    \item \textbf{Autor e referência}:\citet{3gpp.22.101}
\end{itemize}
